...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "inquiry@e-joongang.com",
    pass: "q?0Yl:8xlfv_&qJB34kZ",
  },
});
...
const checkSendMail = () => {
  const mailOptions = {
    ...
    to: "joongang@e-joongang.com",
    subject:
      "(홈페이지 테스트 메일) '제품 및 기술문의' 기능의 테스트 메일입니다",
    html: `
      <div style="width: 600px; padding: 15px; border: 1px solid #ddd; background-color: #eee; border-radius: 5px;">
        <p style="margin: 0;">본 메일은 홈페이지의 "제품 및 기술문의" 기능이 정상적으로 작동하기 위해 10일 간격으로 자동 발송되는 테스트 메일입니다.<br>따라서 본 메일은 무시하여도 됩니다.</p>
      </div>
    `,
  };
